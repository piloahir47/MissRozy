...
class Config(object):
	API_ID = int(os.environ.get("API_ID",38077905))
	API_HASH = os.environ.get("API_HASH", "38077905")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","8678556827:AAF5-7Z9o9Kv_9UAFtC-eOMu7vqZZqdwRNg")
